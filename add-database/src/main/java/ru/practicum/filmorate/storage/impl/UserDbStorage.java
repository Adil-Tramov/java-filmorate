...
public class UserDbStorage implements UserStorage {
    ...
    public Optional<User> findUserById(long id) {
        try {
            ...
            if (user != null) {
                ...
                Set<Long> friendsSet = new HashSet<Long>(friendIds);
    ...
    public List<User> findAll() {
        ...
        for (User u : users) {
            ...
            u.setFriends(new HashSet<Long>(friendIds));
        }
        return users;
    }
    ...
    public void addFriend(long userId, long friendId) {
        jdbcTemplate.update("MERGE INTO user_friend (user_id, friend_id) KEY(user_id, friend_id) VALUES (?, ?)",
                userId, friendId);
    }
